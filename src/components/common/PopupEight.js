    ...
    <>
      {showEight ? (
        <div className="overlay">
          <div className="bg-[#FC9734] rounded-[20px] w-[320px] md:w-[833px] relative flex flex-col md:flex-row items-end mt-[40px] md:mt-[60px] z-[10]">
